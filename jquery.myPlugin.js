(function( $ ) {
    var methods = {
      start : function () {
        var wallSpriteUrl = "http://pngimg.com/uploads/fox/fox_PNG23144.png";
    var heroSpriteUrl = "https://i027.radikal.ru/0912/47/82334c5862d5.png";
var hero = {
  x: 0,
  y: 0,
  vel: {
...
canvas.canvas.style.background = "green";
canvas.canvas.style.width = "800px";
canvas.canvas.style.background = "green";
